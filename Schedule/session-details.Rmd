...
* Presentation of a handful of model settings: Karl-Dieter, Danny, Eric
...
Some examples: 
    * coffee and orange juice, prevalence and incidence, your cell phone
...
* Fitting and precision: statistics for modeling
* Heuristics for model terms
...
* Participant presentations: Your modeling setting.  In your 5 min presentation, you should tell people enough about the facts to let them set up a modeling process.  The Thursday and Friday presentations will focus on modeling approaches to your setting, but for today it's about the background, goals, and facts.
