...
### Finishing up Functions of Two Variables

Thinking about function "shapes" locally.

* Always: a linear function
* Broader: Various simple geological shapes.
    * a mountain: [http://dl.dropbox.com/u/5098197/Math135/Figures/cairo-solar.png Solar energy in Cairo]
    * a hillside, [http://dl.dropbox.com/u/5098197/Math135/Figures/1000px-Body_mass_index_chart.png Body mass index chart]
    * a valley (ridge).[http://en.wikipedia.org/wiki/File:BMIGirls_1.svg  BMI percentiles for girls versus age]. 
        Really this is a kind of hillside, since the labels are for percentiles at each age.  But it could more naturally be displayed as a probability density.
        Here's the same information  [http://en.wikipedia.org/wiki/File:BMIBoys_1.svg for Boys, from Wikipedia]
    ...
    * a saddle or mountain pass. [example][http://stanwagon.com/wagon/Utah/GeorgiesCamp/HTMLLinks/GeorgiesCampCircumnavigation_16.html]
